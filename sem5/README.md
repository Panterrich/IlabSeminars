...
> [!NOTE]
> Помните, чтобы выводы в отчетах были полные и понятными, необходимо подключать дебаг информацию с помощью флага `-g` (`-g3`) во время компиляции.
...
Для запуска программу под отладчиком необходимо скомпилировать программу без оптимизаций (`-O0`) и добавить дебаг информацию (`-ggdb3`). Оптимизации необходимо выключить, чтобы сохранить соответствие строкам кода и соответствующей машинной инструкции, а дебаг информация просто необходимо отладчику для инструментирования кода.
